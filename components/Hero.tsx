  ...
  return (
    <section id="home" className="relative h-screen min-h-[700px] flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img
          src="https://res.cloudinary.com/dxrk58emm/image/upload/v1772276220/Vila-Nova-de-Gaia-como-e-morar-na-cidade-das-caves-de-vinho-do-Porto_yrb3wi.jpg"
          alt="Vila Nova de Gaia Real Estate"
        ...
        <div className="absolute inset-0" style={{ background: 'linear-gradient(to right, rgba(44,44,44,0.92) 0%, rgba(44,44,44,0.55) 50%, transparent 100%)' }}></div>
      </div>
        ...
        <div className="max-w-3xl">
          <Reveal delay={0.2} yOffset={20}>
            <div className="inline-block px-3 py-1 mb-6 border border-white/30 rounded-full bg-white/10 backdrop-blur-sm">
              <span className="text-white text-xs font-semibold tracking-wider uppercase">Consultoria Imobiliária em Vila Nova de Gaia</span>
            </div>
          </Reveal>
          ...
          <Reveal delay={0.4} yOffset={30}>
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-serif font-bold text-white leading-[1.1] mb-6 drop-shadow-sm">
              Venda ou compre casa em Vila Nova de Gaia com acompanhamento profissional e transparente.
            </h1>
          </Reveal>
