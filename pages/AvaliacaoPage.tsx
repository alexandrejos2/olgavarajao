    ...
    <div className="font-sans text-slate-900 bg-white selection:bg-gold-500/20 selection:text-gold-900">
      ...
      <footer className="py-8 bg-white border-t border-gray-100">
        <div className="max-w-5xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <div>
            <p className="font-serif font-bold text-slate-900">CARLOS MATOS</p>
            <p className="text-xs text-gold-500 font-semibold tracking-widest uppercase">RE/MAX White · Coimbra</p>
          </div>
          <p className="text-sm text-slate-400">
            &copy; {new Date().getFullYear()} Carlos Matos. Todos os direitos reservados.
          </p>
        </div>
      </footer>
    </div>
